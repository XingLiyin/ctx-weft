...
5. **H5 死配置限制**（截至 2026-09-11 记分板：H1 ✅ wp3、H2 ✅ wp4、H4 ✅ wp0-wp1——**H1/H2 发布单元（WP2+WP3+WP4）仓内齐备，按方案 §3 宣布解决**；剩 H3 行为未切（wp5 账本就绪）、H5、H6）：`max_turns_per_agent` / `Task.timeout_ms` / `timeout_per_step_sec` 公开声明却零执行点。
