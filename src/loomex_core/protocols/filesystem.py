...
（loomex_core.providers.capability_filesystem.FilesystemToolsProvider）与 host 接线的细节：
...
class SpillSink(ABC):
    ...
    实现见 loomex_core.providers.capability_filesystem.FilesystemToolsProvider。
    """
