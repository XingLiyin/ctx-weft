...
from loomex_core.core.events.types import EVENT_TYPES, Event, EventType
from loomex_core.core.orchestrator.task_queue import QueueEntry, TaskQueue
...
class TaskManager:
    ...
    The caller (SessionManager / LoomeXRuntime) must:
