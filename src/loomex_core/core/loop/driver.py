...
from loomex_core.core.assembler import AssembledPrompt, ContextAssembler
from loomex_core.core.events import Event, EventBus, EventType
...
if TYPE_CHECKING:
    from loomex_core.core.loop.steps.observe import Verdict
    from loomex_core.core.loop.steps.act import TurnRecord
    from loomex_core.core.control.tokens import CancelToken, PauseToken
    from loomex_core.core.loop.capability_gateway import CapabilityGateway
    from loomex_core.core.orchestrator import CapabilityCache, TaskManager
    from loomex_core.core.orchestrator.hitl_manager import HitlManager
    from loomex_core.protocols.capability import CapabilityProvider
    from loomex_core.protocols.template import TemplateResolver
