...
from loomex_core.protocols import LLMMessage, LLMRequest, LLMUsage, ToolCall
...
class ActStep(Step):
    ...
    async def execute(self, state: LoopState, ctx: LoopContext) -> StepOutcome:
        ...
        for turn_num in range(1, max_turns + 1):
            ...
            from loomex_core.core.loop.capability_gateway import DISPATCH_TOOLS, SILENT_TOOLS
...
async def _invoke_tool(tc: ToolCall, state: LoopState, ctx: LoopContext) -> Any:
    ...
    from loomex_core.core.loop.capability_gateway import CapabilityGateway, InvocationResult
